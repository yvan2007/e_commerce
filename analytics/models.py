...
class AnalyticsEvent(models.Model):
    ...
    category_id = models.IntegerField(null=True, blank=True, verbose_name="ID Catégorie")
    search_query = models.CharField(max_length=200, blank=True, verbose_name="Requête de recherche")
...
class SalesReport(models.Model):
    ...
    period = models.CharField(max_length=20, choices=REPORT_PERIODS, verbose_name="Période")
    ...
    total_products_sold = models.IntegerField(default=0, verbose_name="Total produits vendus")
...
class CustomerAnalytics(models.Model):
    ...
    average_session_duration = models.DurationField(
        null=True, 
        blank=True,
        verbose_name="Durée moyenne de session"
    )
...
class GoogleAnalytics(models.Model):
    ...
    property_id = models.CharField(max_length=50, unique=True, verbose_name="ID de propriété")
    ...
    track_enhanced_ecommerce = models.BooleanField(default=True, verbose_name="Suivi e-commerce amélioré")
    ...
    sync_frequency = models.IntegerField(
        default=24, 
        verbose_name="Fréquence de synchronisation (heures)"
    )
...
class DashboardWidget(models.Model):
    ...
    widget_type = models.CharField(max_length=20, choices=WIDGET_TYPES, verbose_name="Type de widget")
