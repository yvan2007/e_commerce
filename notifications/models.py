...
class NotificationTemplate(models.Model):
    ...
    type = models.CharField(max_length=20, choices=NOTIFICATION_TYPES, verbose_name=_("Type"))
    trigger_type = models.CharField(max_length=30, choices=TRIGGER_TYPES, verbose_name=_("Déclencheur"))
...
class Notification(models.Model):
    ...
    template = models.ForeignKey(NotificationTemplate, on_delete=models.CASCADE, verbose_name=_("Modèle"))
    type = models.CharField(max_length=20, choices=NOTIFICATION_TYPES, verbose_name=_("Type"))
    subject = models.CharField(max_length=200, verbose_name=_("Sujet"))
    content = models.TextField(verbose_name=_("Contenu"))
...
class NotificationPreference(models.Model):
    ...
    """
    user = models.OneToOneField(User, on_delete=models.CASCADE, related_name='notification_preferences', verbose_name=_("Utilisateur"))
    
    # Préférences email
    email_order_updates = models.BooleanField(default=True, verbose_name=_("Mises à jour de commande par email"))
    email_promotions = models.BooleanField(default=True, verbose_name=_("Promotions par email"))
    email_newsletter = models.BooleanField(default=True, verbose_name=_("Newsletter par email"))
    email_reviews = models.BooleanField(default=True, verbose_name=_("Avis par email"))
    
    # Préférences SMS
    sms_order_updates = models.BooleanField(default=True, verbose_name=_("Mises à jour de commande par SMS"))
    sms_promotions = models.BooleanField(default=False, verbose_name=_("Promotions par SMS"))
    
    # Préférences push
    push_order_updates = models.BooleanField(default=True, verbose_name=_("Mises à jour de commande par push"))
    push_promotions = models.BooleanField(default=True, verbose_name=_("Promotions par push"))
    push_reviews = models.BooleanField(default=True, verbose_name=_("Avis par push"))
    
    # Préférences in-app
    in_app_order_updates = models.BooleanField(default=True, verbose_name=_("Mises à jour de commande in-app"))
    in_app_promotions = models.BooleanField(default=True, verbose_name=_("Promotions in-app"))
...
class EmailQueue(models.Model):
    ...
    status = models.CharField(max_length=20, choices=STATUS_CHOICES, default='pending', verbose_name=_("Statut"))
    priority = models.IntegerField(choices=PRIORITY_CHOICES, default=3, verbose_name=_("Priorité"))
    retry_count = models.PositiveIntegerField(default=0, verbose_name=_("Nombre de tentatives"))
    max_retries = models.PositiveIntegerField(default=3, verbose_name=_("Tentatives maximum"))
    scheduled_at = models.DateTimeField(blank=True, null=True, verbose_name=_("Programmé pour"))
    sent_at = models.DateTimeField(blank=True, null=True, verbose_name=_("Envoyé le"))
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
