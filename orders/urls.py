...
urlpatterns = [
    ...
    path(
        "commande/<str:order_number>/",
        views.OrderDetailView.as_view(),
        name="order_detail",
    ),
    path(
        "commande/<str:order_number>/cancel/",
    ...
    path(
        ...
        api_views.calculate_delivery_fee,
        name="calculate_delivery_fee",
    ),
    path(
        "api/update-cart-totals/",
        api_views.update_cart_totals,
        name="update_cart_totals",
    ),
    path(
        "api/cart/<int:item_id>/update/",
        api_views.update_cart_item_ajax,
        name="update_cart_item",
    ),
    path(
        "api/cart/<int:item_id>/remove/",
        api_views.remove_cart_item_ajax,
        name="remove_cart_item",
    ),
    path("api/create-order/", api_views.create_order_ajax, name="create_order_ajax"),
    path(
        "api/commande/<str:order_number>/cancel/",
        api_views.cancel_order_ajax,
        name="cancel_order_ajax",
    ),
    path("api/regions/", api_views.get_regions, name="get_regions"),
    path(
        "api/regions/<int:region_id>/cities/", api_views.get_cities, name="get_cities"
    ),
    path(
        "api/delivery-methods/",
        api_views.get_country_delivery_methods,
        name="get_delivery_methods",
    ),
    path(
        "api/payment-logo/<str:method>/",
        api_views.get_payment_method_logo,
        name="get_payment_logo",
    ),
]
