...
class Order(models.Model):
    ...
    order_number = models.CharField(
        max_length=20, unique=True, verbose_name=_("Numéro de commande")
    )

    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="orders", verbose_name=_("Client")
    )
    ...
    shipping_first_name = models.CharField(max_length=100, verbose_name=_("Prénom"))

    shipping_last_name = models.CharField(max_length=100, verbose_name=_("Nom"))

    shipping_phone = models.CharField(max_length=20, verbose_name=_("Téléphone"))

    shipping_address = models.TextField(verbose_name=_("Adresse"))

    shipping_city = models.CharField(max_length=100, verbose_name=_("Ville"))
    ...
    shipping_country = models.CharField(
        max_length=100, default="Côte d'Ivoire", verbose_name=_("Pays")
    )

    # Adresse de facturation (optionnelle)
    billing_address = models.TextField(
        blank=True, null=True, verbose_name=_("Adresse de facturation")
    )
    ...
    payment_reference = models.CharField(
        max_length=100, blank=True, null=True, verbose_name=_("Référence de paiement")
    )

    payment_date = models.DateTimeField(
        blank=True, null=True, verbose_name=_("Date de paiement")
    )
...
class OrderItem(models.Model):
    ...
    product = models.ForeignKey(
        "products.Product", on_delete=models.CASCADE, verbose_name=_("Produit")
    )
...
class CartItem(models.Model):
    ...
    cart = models.ForeignKey(
        Cart, on_delete=models.CASCADE, related_name="items", verbose_name=_("Panier")
    )
...
class OrderStatusHistory(models.Model):
    ...
    status = models.CharField(
        max_length=20, choices=Order.STATUS_CHOICES, verbose_name=_("Statut")
    )
