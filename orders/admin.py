...
class OrderAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            ...
            {"fields": ("billing_address",), "classes": ("collapse",)},
        ),
        (
            _("Montants"),
        ...
        (
            ...
            {"fields": ("shipped_at", "delivered_at"), "classes": ("collapse",)},
        ),
    )
    ...
    def mark_as_processing(self, request, queryset):
        ...
        self.message_user(
            request, f"{updated} commande(s) marquée(s) comme en cours de traitement."
        )
...
class OrderItemAdmin(admin.ModelAdmin):
    ...
    def get_queryset(self, request):
        return (
            super().get_queryset(request).select_related("order", "product", "variant")
        )
...
class ShippingAddressAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_("Adresse"), {"fields": ("address", "city", "postal_code", "country")}),
        (
            _("Dates"),
