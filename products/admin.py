...
class ProductAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_("Vendeur et catégorie"), {"fields": ("vendor", "category", "tags")}),
        (
            _("Prix et stock"),
            {"fields": ("price", "compare_price", "stock", "min_stock")},
        ),
        (_("Image principale"), {"fields": ("main_image",)}),
        (_("Statut"), {"fields": ("status", "is_featured", "is_digital")}),
        (
            _("Statistiques"),
            {
    ...
    def unfeature_products(self, request, queryset):
        ...
        self.message_user(
            request, f"{updated} produit(s) retiré(s) de la vedette avec succès."
        )

    unfeature_products.short_description = (
        "Retirer de la vedette les produits sélectionnés"
    )
...
class ProductReviewAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_("Statut"), {"fields": ("is_approved", "is_verified_purchase")}),
        (_("Engagement"), {"fields": ("helpful_votes",)}),
        (
            _("Dates"),
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
