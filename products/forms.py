...
class ProductSearchForm(forms.Form):
    ...
    query = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "Rechercher un produit..."}
        ),
    )
    ...
    min_price = forms.DecimalField(
        ...
        widget=forms.NumberInput(
            attrs={"class": "form-control", "placeholder": "Prix min", "step": "0.01"}
        ),
    )
    max_price = forms.DecimalField(
        required=False,
        widget=forms.NumberInput(
            attrs={"class": "form-control", "placeholder": "Prix max", "step": "0.01"}
        ),
    )
