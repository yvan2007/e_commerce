...
class DeliveryProductReview(models.Model):
    ...
    image_1 = models.ImageField(
        upload_to="reviews/images/", blank=True, null=True, verbose_name=_("Photo 1")
    )
    image_2 = models.ImageField(
        upload_to="reviews/images/", blank=True, null=True, verbose_name=_("Photo 2")
    )
    image_3 = models.ImageField(
        upload_to="reviews/images/", blank=True, null=True, verbose_name=_("Photo 3")
    )

    # Métadonnées
    is_verified_purchase = models.BooleanField(
        default=True, verbose_name=_("Achat vérifié")
    )
    is_helpful = models.PositiveIntegerField(
        default=0, verbose_name=_("Nombre de 'utile'")
    )
...
class DeliveryReview(models.Model):
    ...
    delivery_comment = models.TextField(
        blank=True, verbose_name=_("Commentaire sur la livraison")
    )
...
class ReviewHelpful(models.Model):
    ...
    is_helpful = models.BooleanField(default=True, verbose_name=_("Utile"))
...
class ReviewResponse(models.Model):
    ...
    vendor = models.ForeignKey(
        User, on_delete=models.CASCADE, verbose_name=_("Vendeur")
    )
