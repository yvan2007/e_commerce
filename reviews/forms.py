...
class DeliveryReviewForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['delivery_rating', 'delivery_comment', 'delivery_speed_rating', 'packaging_rating', 'delivery_person_rating']
        widgets = {
            ...
            'delivery_person_rating': forms.RadioSelect(attrs={'class': 'rating-input'}),
    ...
    class Meta:
        ...
        widgets = {
            'response_text': forms.Textarea(attrs={
                'class': 'form-control',
                'rows': 3,
                'placeholder': _('Répondez à cet avis de manière professionnelle...')
            }),
        }
        labels = {
