    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message_type', models.CharField(choices=[('text', 'Texte'), ('image', 'Image'), ('file', 'Fichier'), ('system', 'Système'), ('order', 'Commande'), ('product', 'Produit')], default='text', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room_type', models.CharField(choices=[('support', 'Support client'), ('product', 'Question produit'), ('general', 'Général')], default='support', max_length=20)),
                ('status', models.CharField(choices=[('active', 'Actif'), ('closed', 'Fermé'), ('pending', 'En attente')], default='pending', max_length=20)),
                ...
                ('customer', models.ForeignKey(limit_choices_to={'user_type': 'client'}, on_delete=django.db.models.deletion.CASCADE, related_name='customer_chats', to=settings.AUTH_USER_MODEL)),
                ...
                ('vendor', models.ForeignKey(blank=True, limit_choices_to={'user_type': 'vendeur'}, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='vendor_chats', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='chatroom',
            index=models.Index(fields=['customer', 'status'], name='chat_chatro_custome_4c25fe_idx'),
        ),
        migrations.AddIndex(
            model_name='chatroom',
            index=models.Index(fields=['vendor', 'status'], name='chat_chatro_vendor__92e802_idx'),
        ),
        migrations.AddIndex(
            model_name='chatroom',
            index=models.Index(fields=['status', 'priority'], name='chat_chatro_status_ff0979_idx'),
        ),
