...
from products.models import Category, Product, ProductImage, ProductVariant, ProductReview, Tag
...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'phone_number', 'country_code', 'address', 'city', 'postal_code',
...
class UserProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = UserProfile
        fields = [
            'id', 'bio', 'website', 'facebook', 'twitter', 'instagram',
...
class VendorProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'business_license', 'tax_id', 'bank_account', 'description',
            'is_approved', 'rating', 'total_sales', 'created_at', 'updated_at'
        ]
...
class ProductReviewSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'comment', 'verified_purchase', 'approved', 'helpful_votes',
            'created_at', 'updated_at'
        ]
...
class ProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'vendor', 'vendor_name', 'category', 'category_name', 'tags',
            'price', 'compare_price', 'stock', 'min_stock', 'main_image',
            'images', 'variants', 'reviews', 'status', 'is_featured',
            'is_digital', 'views', 'sales_count', 'rating', 'average_rating',
            'review_count', 'created_at', 'updated_at'
        ]
        read_only_fields = [
            'id', 'views', 'sales_count', 'rating', 'created_at', 'updated_at'
        ]
...
class OrderStatusHistorySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'status', 'notes', 'created_by', 'created_by_name',
            'created_at'
        ]
        read_only_fields = ['id', 'created_at']
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'shipping_country', 'billing_address', 'subtotal', 'shipping_cost',
            'tax_amount', 'total_amount', 'notes', 'payment_reference',
