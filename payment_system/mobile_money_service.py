...
class MobileMoneyService:
    ...
    def __init__(self):
        self.mtn_config = {
            ...
            'subscription_key': getattr(settings, 'MTN_SUBSCRIPTION_KEY', 'your-mtn-subscription-key'),
            'environment': getattr(settings, 'MTN_ENVIRONMENT', 'sandbox'),  # sandbox ou production
        }
        
        self.moov_config = {
            'api_key': getattr(settings, 'MOOV_API_KEY', 'your-moov-api-key'),
            'environment': getattr(settings, 'MOOV_ENVIRONMENT', 'sandbox'),  # sandbox ou production
        }
        
        self.orange_config = {
            'api_url': 'https://api.orange.com',
            'client_id': getattr(settings, 'ORANGE_CLIENT_ID', 'your-orange-client-id'),
            'client_secret': getattr(settings, 'ORANGE_CLIENT_SECRET', 'your-orange-client-secret'),
            'merchant_id': getattr(settings, 'ORANGE_MERCHANT_ID', 'your-orange-merchant-id'),
        }
        
        self.wave_config = {
            'api_url': 'https://api.wave.com',
            'api_key': getattr(settings, 'WAVE_API_KEY', 'your-wave-api-key'),
            'merchant_id': getattr(settings, 'WAVE_MERCHANT_ID', 'your-wave-merchant-id'),
        }
    ...
    def _initiate_moov_payment(self, amount: Decimal, phone_number: str, 
        ...
        try:
            ...
            moov = Moov(
                api_key=self.moov_config['api_key']
            )
