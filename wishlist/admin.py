...
class WishlistShareAdmin(admin.ModelAdmin):
    list_display = ['wishlist', 'shared_by', 'shared_with_email', 'is_active', 'created_at', 'viewed_at']
    list_filter = ['is_active', 'created_at', 'viewed_at']
    search_fields = ['wishlist__user__username', 'shared_with_email', 'shared_by__username']
