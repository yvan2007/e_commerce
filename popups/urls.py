...
urlpatterns = [
    ...
    path('api/popup-interaction/', views.track_popup_interaction, name='track_popup_interaction'),
    ...
    path('api/cookie-consent/get/', views.get_cookie_consent, name='get_cookie_consent'),
