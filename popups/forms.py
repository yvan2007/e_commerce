...
class PopupForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "show_to_authenticated": forms.CheckboxInput(
                attrs={"class": "form-check-input"}
            ),
            "show_to_anonymous": forms.CheckboxInput(
                attrs={"class": "form-check-input"}
            ),
            "user_types": forms.CheckboxSelectMultiple(
                attrs={"class": "form-check-input"}
            ),
            "pages": forms.Textarea(
                attrs={
                    "class": "form-control",
                    "rows": 3,
                    "placeholder": "Une page par ligne",
                }
            ),
...
class CaptchaChallengeForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        if challenge_type in ["image", "checkbox"] and not options:
            raise ValidationError(
                "Les défis de type image et checkbox nécessitent des options."
            )
    ...
    class Meta:
        ...
        widgets = {
            ...
            "min_age": forms.NumberInput(
                attrs={"class": "form-control", "min": "13", "max": "25"}
            ),
            "is_active": forms.CheckboxInput(attrs={"class": "form-check-input"}),
            "show_on_all_pages": forms.CheckboxInput(
                attrs={"class": "form-check-input"}
            ),
            "pages": forms.Textarea(
                attrs={
...
class AgeVerificationForm(forms.Form):
    ...
    def clean_birth_date(self):
        ...
        if birth_date:
            ...
            if age < 13:
                raise ValidationError(
                    "Vous devez avoir au moins 13 ans pour utiliser ce site."
                )
...
class CaptchaForm(forms.Form):
    ...
    answer = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "Entrez votre réponse"}
        ),
    )
