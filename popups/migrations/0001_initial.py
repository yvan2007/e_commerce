    ...
    operations = [
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("age_verification", "Vérification âge"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(default="Vérification d'âge", max_length=200),
                ),
                (
                    "message",
                    models.TextField(
                        default="Vous devez avoir au moins 18 ans pour accéder à ce site."
                    ),
                ),
                (
                    "min_age",
