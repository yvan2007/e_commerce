...
from .models import (
    Supplier, StockAlert, InventoryTransaction, 
    ProductSupplier, StockMovement, InventoryReport
)


@admin.register(Supplier)
class SupplierAdmin(admin.ModelAdmin):
    list_display = ['name', 'contact_person', 'email', 'phone', 'status', 'rating', 'get_total_products']
    ...
    fieldsets = (
        ...
        ('Informations commerciales', {
            'fields': ('payment_terms', 'rating', 'notes')
        }),
        ('Métadonnées', {
...
class StockAlertAdmin(admin.ModelAdmin):
    list_display = ['product', 'alert_type', 'priority', 'current_stock', 'threshold_value', 'is_resolved', 'created_at']
    ...
    fieldsets = (
        ('Alerte', {
            'fields': ('product', 'alert_type', 'priority', 'threshold_value', 'current_stock')
        }),
        ('Message', {
            'fields': ('message',)
        }),
...
class InventoryTransactionAdmin(admin.ModelAdmin):
    list_display = ['transaction_id', 'product', 'transaction_type', 'quantity', 'unit_cost', 'total_cost', 'supplier', 'created_at']
...
class ProductSupplierAdmin(admin.ModelAdmin):
    list_display = ['product', 'supplier', 'supplier_sku', 'cost_price', 'minimum_order_quantity', 'lead_time_days', 'is_primary', 'is_active']
