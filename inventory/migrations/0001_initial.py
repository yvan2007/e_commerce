...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('movement_type', models.CharField(choices=[('sale', 'Vente'), ('return', 'Retour'), ('adjustment', 'Ajustement'), ('transfer', 'Transfert'), ('damage', 'Dégât'), ('expired', 'Expiré')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('alert_type', models.CharField(choices=[('low_stock', 'Stock bas'), ('out_of_stock', 'Rupture de stock'), ('overstock', 'Surstock'), ('expiring', 'Expiration proche')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction_type', models.CharField(choices=[('in', 'Entrée'), ('out', 'Sortie'), ('adjustment', 'Ajustement'), ('transfer', 'Transfert'), ('return', 'Retour')], max_length=20)),
                ('quantity', models.IntegerField(verbose_name='Quantité')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('report_type', models.CharField(choices=[('stock_levels', 'Niveaux de stock'), ('movements', 'Mouvements'), ('alerts', 'Alertes'), ('valuation', 'Évaluation'), ('turnover', 'Rotation')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('supplier_sku', models.CharField(blank=True, max_length=100, verbose_name='SKU fournisseur')),
