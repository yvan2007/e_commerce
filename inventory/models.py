...
class Supplier(models.Model):
    ...
    country = models.CharField(
        max_length=100, default="Côte d'Ivoire", verbose_name="Pays"
    )
    tax_id = models.CharField(max_length=50, blank=True, verbose_name="Numéro fiscal")
    payment_terms = models.CharField(
        max_length=100, default="30 jours", verbose_name="Conditions de paiement"
    )
...
class InventoryTransaction(models.Model):
    ...
    created_by = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="inventory_transactions"
    )
...
class ProductSupplier(models.Model):
    ...
    product = models.ForeignKey(
        "products.Product", on_delete=models.CASCADE, related_name="suppliers"
    )
    supplier = models.ForeignKey(
        Supplier, on_delete=models.CASCADE, related_name="products"
    )
    supplier_sku = models.CharField(
        max_length=100, blank=True, verbose_name="SKU fournisseur"
    )
