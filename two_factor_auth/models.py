...
class TwoFactorAuth(models.Model):
    ...
    # Codes de sauvegarde
    backup_codes = models.JSONField(default=list, blank=True, verbose_name="Codes de sauvegarde")
...
class TwoFactorDevice(models.Model):
    ...
    device_type = models.CharField(max_length=20, choices=DEVICE_TYPES, verbose_name="Type d'appareil")
    device_fingerprint = models.CharField(max_length=100, unique=True, verbose_name="Empreinte appareil")
