...
from .models import DeliveryZone, DeliveryAddress, Region, City
...
class DeliveryService:
    ...
    def calculate_delivery_fee(city, country='Côte d\'Ivoire'):
        ...
        cities_to_zones = {
            # Abidjan
            'abidjan': 'abidjan', 'cocody': 'abidjan', 'yopougon': 'abidjan', 
            'marcory': 'abidjan', 'treichville': 'abidjan', 'adjame': 'abidjan',
            'plateau': 'abidjan', 'abobo': 'abidjan', 'anyama': 'abidjan',
            'koumassi': 'abidjan', 'port-bouet': 'abidjan', 'bingerville': 'abidjan',
            'attécoubé': 'abidjan', 'williamsville': 'abidjan', 'attecoube': 'abidjan',
            
            # Grand-Bassam
            'grand-bassam': 'bassam', 'grand bassam': 'bassam', 'bassam': 'bassam',
            'jacqueville': 'bassam', 'bonoua': 'bassam',
            
            # San-Pédro
            'san-pédro': 'sanpedro', 'san pedro': 'sanpedro', 'sanpedro': 'sanpedro',
            'sassandra': 'sanpedro', 'tabou': 'sanpedro',
            
            # Yamoussoukro
            'yamoussoukro': 'yamoussoukro', 'yamossoukro': 'yamoussoukro',
            'duekoue': 'yamoussoukro', 'duékoué': 'yamoussoukro',
            'tabé': 'yamoussoukro', 'bangolo': 'yamoussoukro',
            
            # Bouaké
            'bouaké': 'bouake', 'bouake': 'bouake',
            'katiola': 'bouake', 'boundiali': 'bouake',
            
            # Daloa
            'daloa': 'daloa', 'issia': 'daloa', 'oumé': 'daloa', 'oume': 'daloa',
            
            # Korhogo
            'korhogo': 'korhogo', 'tingrela': 'korhogo', 'korogo': 'korhogo',
            'ferkessedougou': 'korhogo', 'ferkessédougou': 'korhogo', 'ferkesse': 'korhogo',
            
            # Man
            'man': 'man', 'duékoué': 'man', 'duekoue': 'man',
            'guiglo': 'man', 'touba': 'man',
            
            # Gagnoa
            'gagnoa': 'gagnoa', 'ouragahio': 'gagnoa',
            
            # Divo
            'divo': 'divo', 'lakota': 'divo',
            
            # Abengourou
            'abengourou': 'abengourou', 'agboville': 'abengourou', 'agnibilekrou': 'abengourou',
            
            # Odienné
            'odienné': 'odienne', 'odienne': 'odienne',
            'seguela': 'odienne', 'séguela': 'odienne', 'madinan': 'odienne',
        }
        ...
        try:
            ...
            zone = DeliveryZone.objects.filter(is_active=True, zone_type='civ_other').first()
            if not zone:
    ...
    def get_zone_by_city(city):
        ...
        abidjan_cities = [
            ...
            'adjame', 'plateau', 'koumassi', 'attecoube', 'songon',
            'anyama', 'bassam', 'port-bouet', 'abobo', 'dabou'
        ]
