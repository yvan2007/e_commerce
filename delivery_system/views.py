...
from .models import DeliveryAddress, DeliveryCalculation, DeliveryZone
...
def delivery_dashboard(request):
    ...
    zone_performance = (
        DeliveryCalculation.objects.values("zone__name")
        .annotate(total_count=Count("id"), total_fees=Sum("total_delivery_fee"))
