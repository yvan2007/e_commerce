...
class Region(models.Model):
    ...
    name = models.CharField(
        max_length=100, unique=True, verbose_name=_("Nom de la région")
    )
...
class DeliveryZone(models.Model):
    ...
    estimated_days = models.PositiveIntegerField(
        default=1, verbose_name=_("Délai de livraison estimé (jours)")
    )

    is_active = models.BooleanField(default=True, verbose_name=_("Zone active"))
...
class DeliveryAddress(models.Model):
    ...
    address_line_1 = models.CharField(max_length=255, verbose_name=_("Adresse ligne 1"))

    address_line_2 = models.CharField(
        max_length=255, blank=True, null=True, verbose_name=_("Adresse ligne 2")
    )
...
class DeliveryCalculation(models.Model):
    ...
    zone = models.ForeignKey(
        DeliveryZone, on_delete=models.CASCADE, verbose_name=_("Zone de livraison")
    )

    base_fee = models.DecimalField(
        max_digits=10, decimal_places=2, verbose_name=_("Frais de base")
    )
    ...
    total_delivery_fee = models.DecimalField(
        max_digits=10, decimal_places=2, verbose_name=_("Total frais de livraison")
    )
