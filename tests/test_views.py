...
class CartViewTest(TestCase):
    ...
    def test_remove_from_cart_ajax(self):
        ...
        # Supprimer l'article
        response = self.client.post(
            reverse("products:remove_from_cart", kwargs={"item_id": cart_item.pk}),
            HTTP_X_REQUESTED_WITH="XMLHttpRequest",
        )
...
class PaymentViewTest(TestCase):
    ...
    def test_initiate_payment(self):
        ...
        response = self.client.post(
            reverse(
                "payment_system:initiate_payment", kwargs={"order_id": self.order.id}
            ),
...
class WishlistViewTest(TestCase):
    ...
    def test_add_to_wishlist_ajax(self):
        ...
        response = self.client.post(
            reverse("wishlist:add_to_wishlist", kwargs={"product_id": self.product.pk}),
            HTTP_X_REQUESTED_WITH="XMLHttpRequest",
        )
    ...
    def test_remove_from_wishlist_ajax(self):
        ...
        response = self.client.post(
            reverse(
                "wishlist:remove_from_wishlist", kwargs={"product_id": self.product.pk}
            ),
            HTTP_X_REQUESTED_WITH="XMLHttpRequest",
        )
