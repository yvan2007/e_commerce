...
urlpatterns = [
    ...
    path(
        "admin/users/<int:user_id>/toggle-vendor-approval/",
        views.admin_vendor_toggle_approval,
        name="admin_vendor_toggle_approval",
    ),
    ...
    # APIs
    path(
        "api/approve-review/<int:review_id>/",
        views.approve_review,
        name="approve_review",
    ),
    path(
        "api/delete-review/<int:review_id>/", views.delete_review, name="delete_review"
    ),
    path(
        "api/toggle-product-status/<int:product_id>/",
        views.toggle_product_status,
        name="toggle_product_status",
    ),
    path(
        "api/toggle-user-status/<int:user_id>/",
