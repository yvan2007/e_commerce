...
class DeliveryZone(models.Model):
    ...
    # Zone géographique
    country = models.ForeignKey(Country, on_delete=models.CASCADE, related_name='delivery_zones')
...
class DeliveryMethod(models.Model):
    ...
    # Zones applicables
    delivery_zones = models.ManyToManyField(DeliveryZone, blank=True, related_name='delivery_methods')
...
class DeliveryTracking(models.Model):
    ...
    delivery_method = models.ForeignKey(DeliveryMethod, on_delete=models.CASCADE, related_name='trackings')
    delivery_zone = models.ForeignKey(DeliveryZone, on_delete=models.CASCADE, related_name='trackings')
