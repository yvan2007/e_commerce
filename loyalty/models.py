...
class LoyaltyPoints(models.Model):
    ...
    def add_points(self, amount, reason=""):
        ...
        LoyaltyPointsHistory.objects.create(
            user=self.user, points=amount, reason=reason, balance_after=self.points
        )
...
class LoyaltyPointsHistory(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="loyalty_history"
    )
...
class UserReward(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="user_rewards"
    )
